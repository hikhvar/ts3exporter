...
func TestVirtualServerStructTags(t *testing.T) {
	...
	expected := VirtualServer{
		...
		Uptime:                         11088,
		ChannelsOnline:                 6,
		MaxDownloadTotalBandwidth:      1.8446744073709552e+19,
